...
As we can see that the model predicted a positive prediction rate of about 87% and negative prediction rate of 95% where the positive class being fraudulent transaction. 
